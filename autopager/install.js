var APP_DISPLAY_NAME = "autopager";
var APP_NAME = "autopager";
var APP_PACKAGE = "/informaction/autopager";
var APP_VERSION = "0.8.0.10";

var APP_PREFS_FILE="defaults/preferences/autopagerdef.js";
var APP_XPCOM_SERVICE="components/AutopagerCOMP.js";
var APP_JAR_FILE = "autopager.jar";
var APP_CONTENT_FOLDER = "content/";
var APP_LOCALES = [
  "zh-CN", "zh-TW","nl","en-US","fr","de","it-IT","ja-JP","pt-BR","tr-TR","hu-HU","he-IL","vi","pl-PL","ro","es","sv-SE"
  ];
  //"it-IT","ja-JP",

var APP_SUCCESS_MESSAGE = APP_DISPLAY_NAME+" should now be available on the statusbar when you restart Mozilla.";

var INST_TO_PROFILE = "Do you wish to install "+APP_DISPLAY_NAME+" to your profile?\nThis will mean it does not need reinstalling when you update Mozilla.\n(Click Cancel if you want "+APP_DISPLAY_NAME+" installing to the Mozilla directory.)";
...
function myPerformInstall(secondTry) {
  ...
  if(err == SUCCESS) {
    ...
    var chromeFlag=instToProfile?PROFILE_CHROME:DELAYED_CHROME;
