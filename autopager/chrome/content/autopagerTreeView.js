...
//      }
  ...
  getCellProperties: function getCellProperties(index, treecol) {
      var site = this.getItemAtIndex(index).site;
    if (site==null)
    {
    ...
    if (site!=null)
    {
          var aserv=Components.classes["@mozilla.org/atom-service;1"].
              getService(Components.interfaces.nsIAtomService);
          return aserv.getAtom("status" + getColor(site));

      }
      return '';
  },
  getColumnProperties: function getColumnProperties(treecol) { },
